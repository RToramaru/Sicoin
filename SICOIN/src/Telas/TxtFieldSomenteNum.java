/*
 * Classe para restrição de caractere do JTextField.
 */
package Telas;
...
/**
 *
 * @author Adevaldo dos Santos Pinto Júnior e Aroldo Junio Ferreira
 */
public final class TxtFieldSomenteNum extends JTextField {

    private int maximoCaracteres = -1;// definição de -1 como  valor normal de um textfield sem limite de caracters

    public TxtFieldSomenteNum() {
        super();
    ...
    public TxtFieldSomenteNum(int maximo) {
        super();
